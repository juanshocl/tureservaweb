...
<html xmlns="http://www.w3.org/1999/xhtml"
  ...
  <script>
    ...
    <meta name="description" content="A design element gallery for web designers and web developers. Find snippets using HTML, CSS, Javascript, jQuery, and ">
      <title>Page not found! | Bootsnipp.com</title>
...
<!--        <li class=""><a href="https://s.bootsnipp.com/about" class="animate">About</a></li>-->
        <li><a href="https://s.bootsnipp.com/user/snippets/new" class="">+ New Snippet</a></li>
        <li>
...
-->
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li class=""><a href="https://s.bootsnipp.com/snippets/featured" class="">Featured <span class="pull-right glyphicon glyphicon-star"></span></a></li>
			...
			<h1>Oops! 404, page not found!</h1>
				<div class="row">
					...
					<div class="col-sm-4">
						<h2>Try these: </h2>
						<ul>
							<li><a href="https://s.bootsnipp.com">Home page</a></li>
							<li><a href="https://s.bootsnipp.com/search">Search</a></li>
							<li><a href="https://s.bootsnipp.com/buttons">Button Builder</a></li>
						</ul>
					</div>
			</div>			
		</div>
  ...
  <div class="container">
    ...
    <p>Bootsnipp.com &copy; 2015 <a href="http://www.danstools.com" target="_blank">Dan's Tools</a> | <a href="https://s.bootsnipp.com/privacy" target="_blank">Site Privacy policy</a> | <a href="https://www.buysellads.com/buy/detail/270577" rel="nofollow">Advertise</a> | Featured snippets are <a href="https://s.bootsnipp.com/license">MIT license.</a> </p>
  </div>
<style>
